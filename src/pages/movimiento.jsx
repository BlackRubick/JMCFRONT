...
const Movimiento = () => {
  ...
  const userId = 123; 
  const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NSwiZXhwIjoxNjg5ODQ2MTI4fQ.tp2T4I5sNsyVP7iRE5q75VFy6GgL7fD848Inep98whk"; 
  ...
  fetch("http://192.168.0.100:8001/sensor-list/123/", {
    ...
    .then((data) => {
      ...
      setMovement(data.data[longitud].movement);
    })
    .catch((error) => {
...
>
          ...
          >
{Math.round(Math.random()) === 0 ? 'No se detecta movimiento' : 'Se detectó movimiento'}
</div>
        </div>
      </div>
    </div>
